...
type PropertyRentType = {
  /** Style props */
  propBackgroundImage?: Property.BackgroundImage;
};

const PropertyRent: NextPage<PropertyRentType> = ({ propBackgroundImage }) => {
  ...
  return (
    <div
      className="flex-1 rounded-md h-[426px] flex flex-col p-6 box-border items-center justify-end bg-[url(/card-1@3x.png)] bg-cover bg-no-repeat bg-[top] min-w-[355px] max-w-[370px] text-left text-base text-gray-white font-body-regular-600"
      style={card11Style}
    >
